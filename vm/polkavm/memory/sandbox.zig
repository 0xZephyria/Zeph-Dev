...
pub const REGIONS = [_]Region{
    ...
    .{ .start = 0x0007_0000, .end = 0x0007_7FFF, .perm = .readOnly, .name = "Calldata" }, // 32 KB
    .{ .start = 0x0007_8000, .end = 0x0007_BFFF, .perm = .readWrite, .name = "Return" }, // 16 KB
    .{ .start = 0x0007_C000, .end = 0x0007_FFFF, .perm = .readWrite, .name = "Scratch" }, // 16 KB
};
...
pub const calldataEnd: u32 = 0x0007_7FFF;
pub const calldataSize: u32 = 0x0000_8000; // 32 KB

/// Return data region constants
pub const returnStart: u32 = 0x0007_8000;
pub const returnEnd: u32 = 0x0007_BFFF;
pub const returnSize: u32 = 0x0000_4000; // 16 KB

/// Scratch region constants
pub const scratchStart: u32 = 0x0007_C000;
...
pub const SandboxMemory = struct {
    ...
    pub fn checkAccess(self: *const SandboxMemory, addr: u64, size: u64, mode: AccessMode) MemoryError!void {
        _ = self;
        if (size == 0) return;
